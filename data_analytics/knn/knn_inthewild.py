...
train_folder_name = "../../data/embedding_data_contrastive_allm4_npy"
test_folder_name = "../../data/embedding_data_contrastive_inthewild_npy"
results_folder = "../../results/knn_contrastive_results"

def load_embeddings(folder_name, dataset_name, entity_type):
    embeddings_list = []
    labels_list = []
...
for dataset in datasets:
    X_test_human, y_test_human = load_embeddings(test_folder_name, dataset, 'human')
    X_test_machine, y_test_machine = load_embeddings(test_folder_name, dataset, 'machine')
    ...
    results_str += "----------------------------------\n"
    result_file_name = f"knn_contrastive_results_{dataset}.txt"

...
best_model_path = os.path.join(results_folder, 'best_model.pth')  # Path to save the best model
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join(results_folder, 'train_val_loss_plot.png'))  # Save plot to file
...
with open(os.path.join(results_folder, 'in_the_wild_stats.txt'), 'w') as f:

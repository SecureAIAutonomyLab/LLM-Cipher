...
# print("Number of samples in each class for training split:")
# for u, c in zip(unique_train, counts_train):
#     print(f"Class {classes[u]}: {c} samples")

# print("\nNumber of samples in each class for validation split:")
# for u, c in zip(unique_val, counts_val):
#     print(f"Class {classes[u]}: {c} samples")

# print("\nNumber of samples in each class for testing split:")
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join(results_folder, 'train_val_loss_plot_humanvs5generators.png'))  # Save plot to file
...
with open(os.path.join(results_folder, 'classification_report_humanvs5generators.txt'), 'w') as f:
...
with open(os.path.join(results_folder, 'in_the_wild_stats_humanvs5generators.txt'), 'w') as f:

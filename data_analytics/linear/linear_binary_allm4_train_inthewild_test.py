...
best_model_path = os.path.join(results_folder, 'best_model_linear_binary.pth')  # Path to save the best model
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(os.path.join(results_folder, 'train_val_loss_plot_linear_binary.png'))  # Save plot to file
...
with open(os.path.join(results_folder, 'classification_report_linear_binary.txt'), 'w') as f:
...
with open(os.path.join(results_folder, 'in_the_wild_stats_linear_binary.txt'), 'w') as f:

...
destination_directory = '../data/embedding_data_roberta_adversarial_npy/'
...
# Last split takes any remaining files
...
for filepath in filepaths_to_process:
    ...
    np.save(os.path.join(destination_directory,
            f'{file_name}.npy'), np.array(machine_embeddings))
    # np.save(os.path.join(destination_directory,
    #         f'{file_name}_human_inthewild.npy'), np.array(human_embeddings))

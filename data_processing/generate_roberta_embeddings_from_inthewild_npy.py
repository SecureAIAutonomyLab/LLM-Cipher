...
for filepath in filepaths_to_process:
    ...
    np.save(os.path.join(destination_directory, f'{file_name}_machine_original_cleaned.npy'), np.array(machine_embeddings))
    np.save(os.path.join(destination_directory, f'{file_name}_human_original_cleaned.npy'), np.array(human_embeddings))
